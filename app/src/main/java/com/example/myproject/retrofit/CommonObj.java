...
public class CommonObj {
    ...
    public CommonObj(Activity refactivity1, InterfacePassResponseBackToClass interfacePassResponse){
    ...
    public CommonObj(Activity refactivity1, InterfacePassResponseBackToClassObj interfacePassResponse,String type){
        this.refactivity=refactivity1;
    ...
    private ApiManager connectRetro(String annotationtype, String method){
        ...
        Retrofit retrofit=new Retrofit.Builder().client(objclient).baseUrl(appurl).addConverterFactory(GsonConverterFactory.create()).build();
